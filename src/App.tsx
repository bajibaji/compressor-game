...
const Knob = ({ config, value, onChange, disabled }: KnobProps) => {
  ...
  const handleMove = (clientY: number) => {
    ...
    const sensitivity = window.innerWidth < 768 ? 0.008 : 0.005;
...
export default function App() {
  ...
  return (
    <div className="select-none min-h-screen bg-neutral-950 text-gray-200 font-sans p-2 sm:p-6 flex flex-col items-center justify-center relative overflow-hidden">
      {/* 背景光效 */}
